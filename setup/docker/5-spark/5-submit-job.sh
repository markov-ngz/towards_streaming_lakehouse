ROOT_REPO_DIR=./../../..
JOB_DIR=etl/1-bronze/campaign
JOB_FILE=ingest_campaign.py

# Copy file to container
docker cp $ROOT_REPO_DIR/$JOB_DIR/$JOB_FILE spark-master:/tmp/$JOB_FILE

docker exec -it spark-master /opt/spark/bin/spark-submit \
  --master spark://spark-master:7077 \
  --jars /opt/spark/extra-jars/iceberg-aws-bundle-1.10.1.jar,/opt/spark/extra-jars/iceberg-spark-runtime-4.0_2.13-1.10.1.jar \
